   ...
   <style>
    ...
    <asp:Panel ID="Panel2" runat="server" BackColor="#b0e0e6" CssClass="panel-common" style="width:100%;" Visible="False">
        ...
        <table style="width:100%; box-sizing:border-box;">
            <tr>
                <td class="auto-style4"><asp:Label ID="eId_Title" runat="server"></asp:Label><asp:Label ID="eId_Lebel" runat="server"></asp:Label>
    ...
    <asp:Panel ID="Panel4" runat="server" BackColor="#b0e0e6" CssClass="panel-common" Visible="False">
        ...
        <asp:GridView ID="GridView3" CssClass="gridview" runat="server" OnRowCommand="GridView2_RowCommand" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" AllowPaging="True" EnableSortingAndPagingCallbacks="True">
    <Columns>
        <asp:ButtonField ButtonType="Button" Text="編輯" />
    </Columns>
    <FooterStyle BackColor="White" ForeColor="#000066" />
